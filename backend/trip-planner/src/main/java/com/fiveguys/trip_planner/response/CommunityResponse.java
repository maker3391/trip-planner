...
// =====================================================================
// [요구사항 확인 및 안내]
// 커뮤니티 게시글 응답 DTO(CommunityResponse)입니다.
// 규칙 1~3(우선도, 다중 선택 OR 연산, 자동 전환)은 다수의 게시글을 필터링하여
// '조회'해 올 때 파라미터로 작용하는 로직이므로,
// 개별 게시글의 데이터를 담아 클라이언트에게 반환하는 이 응답 객체 자체에는
// 구조적인 변경(단일 필드를 배열로 바꾼다거나 하는 등)이 필요하지 않습니다.
// (게시글 1개는 여전히 1개의 지정된 카테고리와 1개의 지정된 지역을 가집니다)
//
// 따라서 규칙 4와 5에 따라 설명은 주석으로만 달고,
// 기존의 변수명 및 인수 개수를 일절 변경하지 않은 원본 코드를 그대로 반환합니다.
// =====================================================================
